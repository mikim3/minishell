...
SRCS	= 	ft_tokenizer.c ft_token_processing.c ft_tokenizer_util.c \
			ft_syntax_analysis.c ft_syntax_parse_tree.c ft_syntax_util.c ft_tree.c \
			ft_token_expansion.c \
			ft_doubly_linked_list_1.c ft_doubly_linked_list_2.c ft_doubly_linked_list_3.c ft_envp_doubly_linked_list.c \
